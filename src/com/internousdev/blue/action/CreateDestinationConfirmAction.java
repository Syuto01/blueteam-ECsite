...
public class CreateDestinationConfirmAction extends ActionSupport implements SessionAware {
	...
	public String execute(){
		...
		familyNameKanaErrorMessageList = ic.doCheck("姓ふりがな", familyNameKana, 1, 16, false, false, true, false, false, false, false);
		firstNameKanaErrorMessageList = ic.doCheck("名ふりがな", firstNameKana, 1, 16, false, false, true, false, false, false, false);
		userAddressErrorMessageList = ic.doCheck("住所", userAddress, 10, 50, true, true, true, true, false, true, false);
		telNumberErrorMessageList = ic.doCheck("電話番号", telNumber, 10, 13, false, false, false, true, false, false, false);
		emailErrorMessageList = ic.doCheckForEmail("メールアドレス", email, 10, 32);

		//エラーメッセージのリストに何か入ってるとエラー。
