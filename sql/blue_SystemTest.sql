...
(4,4,"アイロン","あいろん","赤みがかった紫のラインが特徴のアイロン。スチーム機能はもちろん、自立機能も搭載。",3,8000,"./images/household","kaden1.jpg",now(),"目立ち",1,now(),now()),
(5,5,"カメラ","かめら","ヴィンテージデザインを採用したコンデジ。旅行のお供として、重さ、サイズ、また画質も文句なし。",3,105000,"./images/household","kaden2.jpg",now(),"キヤノソ",1,now(),now()),
(6,6,"テレビ","てれび","年代物のテレビ。画面に映る色はモノクロ、本体の部分を発色の良い赤であしらった一品。",3,70000,"./images/household","kaden3.jpg",now(),"フラット",1,now(),now()),
(7,7,"洗濯機","せんたくき","この春、一人暮らしを始めるならこれ。お一人様用サイズの洗濯機。",3,370000,"./images/household","kaden4.png",now(),"西芝",1,now(),now()),

(8,8,"ダーツボード","だーつぼーど","カーボン技術を採用し、表面が超硬質で、性能、耐久性共に向上してます。",4,10371,"./images/toy","toy1.jpg",now(),"blue株式会社",1,now(),now()),
(9,9,"チェス","ちぇす","駒と盤の色合いやデザインにこだわった金属製のセットです。",4,4980,"./images/toy","toy2.jpg",now(),"blue株式会社",1,now(),now()),
(10,10,"ラジコンヘリコプター","らじこんへりこぷたー","モーターの燃費の良さと、ふわふわとしたフライト感が楽しめます。",4,13800,"./images/toy","toy3.jpg",now(),"blue株式会社",1,now(),now()),
(11,11,"クマのぬいぐるみ","くまのぬいぐるみ","本物に近い毛並みになっているクマのぬいぐるみです。",4,3000,"./images/toy","toy4.jpg",now(),"blue株式会社",1,now(),now()),
(12,12,"エクスかリバー","えくすかりばー","内部に芯があり、ガラス繊維で強化されている。簡単に折れません。",4,2980,"./images/toy","toy5.jpg",now(),"blue株式会社",1,now(),now()),

(13,13,"運転免許実技試験1発合格秘伝のCD","うんてんめんきょじつぎしけんいっぱつごうかくひでんのしーでぃ","私はサッカー部だった。ポジションは左サイドベンチ。そんな僕も今では「レギュラー、満タンで。」",5,100,"./images/cd","cd1.png",now(),"株式会社ポッポ",1,now(),now());
